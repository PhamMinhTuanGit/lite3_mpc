...
#include "amd.h"
#include <iostream>
// immintrin.h provides x86 AVX/SSE intrinsics and does not exist on ARM.
// All intrinsic code below is gated behind JCQP_USE_AVX2 (with scalar
// fallbacks), so only include this header when that path is enabled.
#ifdef JCQP_USE_AVX2
#include <immintrin.h>
#endif
